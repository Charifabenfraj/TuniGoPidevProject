...
class BusTrajet
{
    ...
    #[ORM\Column(type: 'string',name: 'stationDepart', nullable: false)]
    ...
    #[ORM\Column(type: 'string',name: 'stationArrivee', nullable: false)]
    ...
    #[ORM\Column(type: 'string',name: 'heureDepart', nullable: false)]
    ...
    #[ORM\Column(type: 'string',name: 'heureArrivee', nullable: false)]

...
final class TrainController extends AbstractController
{
    ...
    #[Route('/{idTrain}', name: 'app_train_show', methods: ['GET'], requirements: ['idTrain' => '\d+'])]
    ...
    #[Route('/{idTrain}/edit', name: 'app_train_edit', methods: ['POST'], requirements: ['idTrain' => '\d+'])]
    public function edit(Request $request, TrainRepository $trainRepository, EntityManagerInterface $entityManager, int $idTrain): JsonResponse
    {
    ...
    #[Route('/{idTrain}', name: 'app_train_delete', methods: ['POST'], requirements: ['idTrain' => '\d+'])]
